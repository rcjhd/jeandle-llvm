; RUN: opt -jeandle-pea-enable-allocation-sinking -disable-output -passes="require<partial-escape-analysis>" \
...
esc:
  call void @sink(ptr addrspace(1) %obj) [ "deopt"(i32 0, i32 0) ]
  call hotspotcc void @jeandle.safepoint_poll() [ "deopt"(i32 0, i32 0) ]
  br label %merge
loc:
  %v = load atomic i32, ptr addrspace(1) %slot unordered, align 4
